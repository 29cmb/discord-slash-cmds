module.exports = {
    SlashCmd(clientObj, cmdName, cmdDescription, type, callback, CompletedMessage, guildId) {
        setTimeout(() => {
            if (clientObj) {
                if (cmdName) {
                    if (cmdDescription) {
                        if (type) {
                            if (callback) {
                                if (CompletedMessage) {
                                    if (guildId) {
                                        console.log(`Creating guild command: ${cmdName}, description: ${cmdDescription}.`)
                                        ...
                                        console.log(`Creating global command ${cmdName}, description: ${cmdDescription}.`)
